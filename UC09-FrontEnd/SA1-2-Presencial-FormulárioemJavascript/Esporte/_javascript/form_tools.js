...
*/
            var append_br = (el, n) => {
                if (n == undefined)
                n = 1;
                for (var i=0; i<n; i++) { var br=document.createElement("br"); el.appendChild(br); } } /* append_span Insere um elemento
                  span com um texto interno. Recebe dois parâmetros: o primeiro é o elemento pai onde será inserido o span, e o segundo
                  é o texto a ser inserido dentro dele. Observe a implementação da função: */ var append_span=(el, text)=> {
...
Insere um botão de submissão do formulário. Recebe três parâmetros: 
